...
public class Recovery implements OnPreferenceChangeListener {

    /**
     * Set location of Recovery parameter
     */
    private static final String FILE_PATH = "/data/local/mackay/chosenrecovery";
    ...
    public static void restore(Context context) {
        ...
        int value = sharedPrefs.getBoolean(DeviceSettings.KEY_CWM, false) ? 1 : 0;
